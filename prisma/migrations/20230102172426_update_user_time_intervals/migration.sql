/*
  ...
  - You are about to drop the column `time_end_in_minuts` on the `user_time_intervals` table. All the data in the column will be lost.
  - You are about to drop the column `time_start_in_minuts` on the `user_time_intervals` table. All the data in the column will be lost.
